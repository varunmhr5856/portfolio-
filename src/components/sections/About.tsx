        ...
        <div className="flex flex-col gap-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                ...
                <GlassCard className="relative p-8 h-full flex flex-col justify-center overflow-hidden border-white/10 bg-[rgba(10,10,10,0.6)]">
                  ...
                  <p className="text-gray-300 leading-relaxed text-[16px] font-sans">
            ...
            <motion.div
              ...
              className="relative aspect-square lg:aspect-auto lg:h-[500px] rounded-2xl overflow-hidden group shadow-2xl"
            >
